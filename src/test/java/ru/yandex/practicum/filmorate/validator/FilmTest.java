...
import static ru.yandex.practicum.filmorate.util.TestFilm.setUpFilm;
...
public class FilmTest {
    ...
    public void createFilm() {
        setUpFilm(film, NAME, DESCRIPTION, DURATION, RELEASE_DATA);
    ...
    public void createFilmWithFailName() {
        setUpFilm(film, "", DESCRIPTION, DURATION, RELEASE_DATA);
    ...
    public void createFilmWithFailDuration() {
        setUpFilm(film, NAME, DESCRIPTION, -200, RELEASE_DATA);
        Assertions.assertFalse(ValidatorTest.getViolations(film).isEmpty());
    }
    ...
    public void createFilmWithFailReleaseDate() {
        setUpFilm(film, NAME, DESCRIPTION, DURATION, LocalDate.of(1867,3,25));
        Assertions.assertFalse(ValidatorTest.getViolations(film).isEmpty());
    }
}
